...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getUserStuff(long userId, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> createComment(long userId, Long itemId, CommentDtoSave commentDto) {
